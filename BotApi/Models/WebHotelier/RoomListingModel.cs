...
namespace BotApi.Models.WebHotelier
{
    public class RoomListingModel
    {
        ...
        public RoomListingModelData Data { get; set; }
    }
    public class RoomListingModelCapacity
    {
    ...
    public class RoomListingModelPhoto
    {
    ...
    public class RoomListingModelRoom
    {
        ...
        public RoomListingModelCapacity Capacity { get; set; }
        ...
        public List<RoomListingModelPhoto> Photos { get; set; }
    }

    public class RoomListingModelData
    {
        [JsonPropertyName("rooms")]
        public List<RoomListingModelRoom> Rooms { get; set; }
    }
}